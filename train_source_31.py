...
def train_source(args):
    ...
    while iter_num < max_iter:
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            netC.eval()
            netD.eval()
            _, acc_list1, accuracy1 = cal_acc(dset_loaders["source_te"], netG, netF, netC)
            _, acc_list2, accuracy2 = cal_acc_easy(dset_loaders["source_te"], netG, netD)
            acc_best = accuracy1
            log_str = (
...
def test_target(args):
    ...
    log_str = (
        "\nDateset: {}, Task: {}, Accuracy_c = {:.2f}%, Accuracy_d = {:.2f}%".format(args.dset, args.name, accuracy1, accuracy2)
        + "\n"
        + str(acc_list1)
    )
    args.out_file.write(log_str + "\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dset", type=str, default="office", choices=["office", "officehome", "visda"])
    ...
    parser.add_argument("--layer", type=str, default="mme", choices=["linear", "wn", "mme"])
