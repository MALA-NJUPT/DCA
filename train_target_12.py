...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dset", type=str, default="visda", choices=["office", "officehome", "visda"]
    )
    parser.add_argument("--lr", type=float, default=5e-4, help="learning rate")
    parser.add_argument(
        "--net", type=str, default="resnet101", help="resnet50, resnet101"
    )
    parser.add_argument('--lamda', type=float, default=0.5, metavar='LAM', help='value of lamda')  # 0.1
    parser.add_argument('--cls_par', type=float, default=0.3)  # 0.05
    parser.add_argument("--mix", type=float, default=1.0)
    parser.add_argument("--seed", type=int, default=2077, help="random seed")
    parser.add_argument("--max_epoch", type=int, default=10, help="max iterations")  # 15
    parser.add_argument("--interval", type=float, default=15, help="max iterations")
    parser.add_argument("--alpha", type=float, default=1.5, help="parameter1")
    parser.add_argument("--beta", type=float, default=1.0, help="parameter2")
